...
import DeleteFromBasketModal from '../delete-from-basket-modal/delete-from-basket-modal.tsx';
    ...
    >
      ...
      >
        <div className="modal__wrapper">
          ...
          {modalType === ModalType.DeleteFromBasket && product && <DeleteFromBasketModal product={product} />}
